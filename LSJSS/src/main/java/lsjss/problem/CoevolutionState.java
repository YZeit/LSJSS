...
public class CoevolutionState extends EvolutionState
{
    /**
     *
     */
    //public InstanceSetSimple trainingSet;
    public InstanceSetFull trainingSet;
    //public InstanceSetSimple validationSet;
    public InstanceSetFull validationSet;
    ...
    public void startFresh()
    {
        ...
        trainingSet = new InstanceSetFull();
        try {
            trainingSet.setup(this, p, "training");
        } catch (IOException e) {
        ...
        p = new Parameter(P_VALIDATION_SET);
        //validationSet = new InstanceSetSimple();
        validationSet = new InstanceSetFull();
        try {
            validationSet.setup(this, p, "validation");
        } catch (IOException e) {
            throw new RuntimeException(e);
        } catch (InvalidFormatException e) {
            throw new RuntimeException(e);
